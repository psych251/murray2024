...
# import data
data <- read.csv("/Users/juliaproshan/Documents/GitHub/murray2024/data/251 Replication - Murray & Koopmann-Holm (2024)_December 2, 2025_23.48.csv")
...
exp_model_simple2 <- lm(Avoided_Neg_composite ~ Condition, data = data)
summary(exp_model_simple2)
Anova(exp_model_simple2) 

# Birgit follow up 
follow_up_model <- lm(
  Avoided_Neg_composite ~ Systemic_Racism_composite + Isolated_Racism_composite + Race,
  data = data
)

# mean deviated mean for ANA (see paper)
# share the dataset 
# email raw data to Birgit 

summary(follow_up_model)

follow_up_model2 <- lm(
  Avoided_Neg_composite ~ Systemic_Racism_composite * Condition + Isolated_Racism_composite + Race,
  data = data
)

summary(follow_up_model2)
