...
ggplot(emm_df, aes(x = Condition, y = emmean, fill = Condition)) +
  geom_col(color = "black", width = 0.6) +          # bars for adjusted means
  geom_errorbar(aes(ymin = emmean - SE, ymax = emmean + SE), 
                width = 0.15, linewidth = 0.8) +    # SE error bars
  labs(
    title = "Systemic Racism Acknowledgment by Condition",
    x = "Condition",
    y = "Adjusted Mean (controlling for Isolated Racism & Ideology)"
  ) +
